export const config = {
  schema: {
    ...
    properties: {
      ...
      title: {
        description: "A property that holds a title of an asset.",
        type: "string"
      },
      id: {
    ...
    required: ["$schema", "description", "image", "title", "id"],
  ...
  metadata: {
    ...
    title: "Experto universitario en desarrollo de aplicaciones blockchain",
    description: "Descripción del título obtenido por el alumno....",
